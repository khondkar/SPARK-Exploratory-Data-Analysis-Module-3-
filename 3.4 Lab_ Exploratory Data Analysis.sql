...
CREATE TABLE outdoorProducts(invoiceNo STRING,stockcode STRING,description STRING,quantity INT,invoiceDate STRING,unitPrice DOUBLE,customerID INT,countryName STRING) USING CSV OPTIONS (
...
CREATE TABLE countryCodes USING parquet OPTIONS (path'/mnt/training/countries/ISOCountryCodes/ISOCountryLookup.parquet',
Header='true');
